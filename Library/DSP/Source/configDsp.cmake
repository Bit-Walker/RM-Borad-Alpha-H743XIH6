...
if (NEON OR NEONEXPERIMENTAL)
    ...
    target_include_directories(${project} PUBLIC "${root}/Library/DSP/ComputeLibrary/Include")
endif()
...
if (HELIUM OR MVEF OR SUPPORT)
   target_include_directories(${project} PRIVATE "${root}/Library/DSP/PrivateInclude")
endif()
