...
/* Definitions for StateLED_Task */
osThreadId_t StateLED_TaskHandle;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PI6 PI5 PI7 */
  ...
  /*Configure GPIO pins : PI4 PI10 PI11 PI12
                           PI13 PI14 PI15 */
  ...
  /*Configure GPIO pins : PD4 PD3 PD15 PD14
                           PD10 */
  ...
  /*Configure GPIO pins : PE2 PE6 PE13 */
  ...
  /*Configure GPIO pins : PE5 PE4 PE3 PE10
                           PE9 PE11 PE15 PE7
                           PE14 */
  GPIO_InitStruct.Pin = GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_3|GPIO_PIN_10
                          |GPIO_PIN_9|GPIO_PIN_11|GPIO_PIN_15|GPIO_PIN_7
                          |GPIO_PIN_14;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PJ11 PJ10 PJ9 PJ8 */
  ...
  /*Configure GPIO pins : PA2 PA1 PA0 */
  ...
  /*Configure GPIO pins : PH3 PH4 PH5 PH9 */
...
/* USER CODE BEGIN Header_Start_StateLED_Toggle */
/**
  * @brief  Function implementing the StateLED_Task thread.
...
/* USER CODE BEGIN Header_Start_IWDG_Refresh */
/**
* @brief Function implementing the IWDG_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_IWDG_Refresh */
__weak void Start_IWDG_Refresh(void *argument)
{
  /* USER CODE BEGIN Start_IWDG_Refresh */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
